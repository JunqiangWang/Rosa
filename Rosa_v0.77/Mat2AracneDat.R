...
#' This function generates the ARACNe mat files from matrix
#' @param  log2CPM if TRUE, log2CPM transformation will be applied
#' @param  write.output if TRUE, the output will be written to files
#' @export
