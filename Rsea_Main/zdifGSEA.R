...
#' @name  DifferentinalSignatureZ
#' @description This function generates direction-adjusted Z scores of the top significantly changed genes
...
wt<-stat$avg_log2FC * unfactor(stat$cluster) %>% as.matrix() %>% t()
