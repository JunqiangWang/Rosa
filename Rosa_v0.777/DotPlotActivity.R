...
#'@description This function do dot plot of the regulators
#'@param markers The markers to plot
#'@param idents The idents to group
#'@param title The title of the plot. The self-defined title is supported
#'@param top.n The top.n markers to plot
#'@param limits The vector of uper and lower limits of the data. Example limits=c(-2, 2)
#'@export
...
Idents(seu)<-idents
  ...
  if(is.null(limits)){
    ...
    # Plot the distribution of the activity and get the top and bottom quantiles
