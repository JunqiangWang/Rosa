#' This function generate an accustomed Heatmap Plot of the differentially expression markers
...
#FindAllMarkers(seu, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
